function HowItWorksCard({index, title, description, icon, className}) {
    return (
        <div className={`rounded-lg relative group hover:shadow-xl transition-all duration-300 border border-gray-200 shadow-lg shadow-gray-100 bg-white text-card-foreground h-full ${className}`}>
