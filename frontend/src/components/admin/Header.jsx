                ...
                <div className="flex items-center space-x-3 pl-3 border-l border-gray-200">
                    ...
                    </div>
                    {
                        user?.image
                            ...
                            :
                            <Link to={`/admin/profile`} className="h-10 w-10 rounded-full bg-gradient-to-r from-[#D19F3E] to-[#E8B86B] flex items-center justify-center text-white font-semibold">
